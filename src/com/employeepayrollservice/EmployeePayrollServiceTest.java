...
public class EmployeePayrollServiceTest {
	...
	public void writeEmpDataToFile() {
		EmployeePayroll[] empsData = { new EmployeePayroll(1, "Azhar", 100000), new EmployeePayroll(2, "Ajay", 200000),
				new EmployeePayroll(4, "Shashank", 400000), new EmployeePayroll(3, "Amit", 300000), };
